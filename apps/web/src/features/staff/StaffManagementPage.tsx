    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 text-xs font-bold text-gray-500">
          ...
          <span>•</span>
          <span className="text-emerald-600">On Shift: {onShiftCount}</span>
          <span>•</span>
          <span className="text-gray-400">Off Shift: {staffList.length - onShiftCount}</span>
        </div>
      </div>
      ...
      {isLoading ? (
        <div className="text-center py-20 bg-white rounded-2xl border border-gray-100">
          ...
          <p className="text-xs font-bold text-gray-600">Loading team directory...</p>
        </div>
      ) : filteredStaff.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-2xl border border-dashed border-gray-200 p-8">
          <ChefHat className="w-12 h-12 text-gray-300 mx-auto mb-3" />
          <p className="font-extrabold text-gray-700 text-base">No staff members found</p>
              ...
              >
                <div>
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-11 h-11 rounded-xl bg-gray-100 border border-gray-200 flex items-center justify-center font-black text-sm text-gray-800">
                    ...
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${
                          staff.isOnShift ? 'bg-emerald-500 animate-pulse' : 'bg-gray-400'
                        }`}
                      />
                ...
                <div className="pt-4 mt-4 border-t border-gray-100 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono font-bold text-xs bg-gray-100 px-2 py-0.5 rounded border border-gray-200 text-gray-800 tracking-widest">
          ...
          <form onSubmit={handleAddSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-center tracking-widest font-mono font-bold text-lg bg-gray-50 border border-gray-300 rounded-xl p-2.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-brand-500"
              />
          ...
          <div className="space-y-4 text-center">
            ...
            <div className="max-w-[200px] mx-auto">
              <input
                ...
                placeholder="• • • •"
                className="w-full text-center tracking-[0.5em] font-mono font-black text-2xl bg-gray-100 border border-gray-300 rounded-xl py-3 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 max-w-[200px] mx-auto">
              {['1', '2', '3', '4', '5', '6', '7', '8', '9', 'C', '0', '⌫'].map((val) => (
                <button
                  ...
                  className="py-2.5 bg-gray-50 hover:bg-gray-200 border border-gray-200 rounded-lg font-bold text-sm text-gray-800 transition-colors"
                >
                  {val}
                </button>
              ))}
            ...
            {pinTestError && (
              <div className="p-3 bg-red-50 border border-red-200 text-red-700 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5">

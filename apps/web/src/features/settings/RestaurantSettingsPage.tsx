  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-4">
            <div className="flex items-center gap-2.5 pb-3 border-b border-gray-100">
              ...
              <h3 className="font-extrabold text-sm text-gray-900">Restaurant Information</h3>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-full text-xs p-2.5 rounded-xl border border-gray-200 font-medium"
                    placeholder="Min"
                  />
            ...
            <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
              <div>
                <p className="font-extrabold text-xs text-gray-900">Accepting Orders Now</p>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-4">
            <div className="flex items-center gap-2.5 pb-3 border-b border-gray-100">
              ...
              <h3 className="font-extrabold text-sm text-gray-900">Weekly Operating Hours</h3>
            </div>
              ...
              {DAYS.map((day, idx) => {
                ...
                return (
                  <div key={day} className="py-3 flex items-center justify-between text-xs">
                    <span className="font-bold text-gray-800 w-28">{day}</span>

                    <div className="flex items-center gap-3">
                      <label className="flex items-center gap-1.5 text-gray-600 font-semibold cursor-pointer">
                        <input
                          type="checkbox"
                      ...
                      {!dayHour.isClosed && (
                        <div className="flex items-center gap-1.5">
                          <input
                            ...
                            className="p-1.5 border border-gray-200 rounded-lg text-xs font-medium"
                          />
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-4">
            <h4 className="font-extrabold text-sm text-gray-900">Publish Changes</h4>
          ...
          <div className="bg-brand-50/50 rounded-2xl p-6 border border-brand-100 space-y-2">
            <h4 className="font-bold text-xs text-brand-900 uppercase tracking-wider">
            ...
            <p className="text-[11px] text-brand-800/80 leading-relaxed pt-1">

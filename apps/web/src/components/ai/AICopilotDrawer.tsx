    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
          ...
          {/* Drawer Container */}
          <div className="relative w-full max-w-lg bg-white shadow-2xl flex flex-col h-full border-l border-gray-200 z-10">
            {/* Header */}
            <div className="p-5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-slate-900 via-brand-950 to-slate-900 text-white">
            ...
            {/* Sub-tabs Navigation */}
            <div className="flex items-center border-b border-gray-100 bg-gray-50/70 p-1.5 gap-1 text-xs font-bold text-gray-600">
              <button
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs font-semibold bg-gray-50 border border-gray-200 rounded-xl p-2.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-brand-500"
                    />
                  </div>
                  ...
                  {copyResult && (
                    <div className="bg-gradient-to-br from-brand-50/70 via-white to-amber-50/50 border border-brand-200 rounded-2xl p-4 space-y-3 shadow-xs">
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] font-black uppercase tracking-wider text-brand-700 flex items-center gap-1">
                          <Sparkles className="w-3 h-3 text-amber-500" />
                          AI Suggested Title
                        </span>
                        <button
                          onClick={() => copyToClipboard(copyResult.title)}
                          className="text-[11px] text-gray-500 hover:text-brand-600 flex items-center gap-1 font-semibold"
                        >
                          <Copy className="w-3 h-3" />
                          Copy Title
                        </button>
                      </div>
                      <p className="font-black text-sm text-gray-900">{copyResult.title}</p>
                      ...
                      <div className="pt-2 border-t border-brand-100/60">
                        ...
                        <p className="text-xs text-gray-700 leading-relaxed italic bg-white/80 p-2.5 rounded-xl border border-gray-100">
                          "{copyResult.description}"
                        </p>
                      </div>

                      <div className="flex items-center justify-between pt-2 border-t border-brand-100/60 text-xs">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          {copyResult.dietaryTags.map((tag, i) => (
                            <span
                              key={i}
                              className="px-2 py-0.5 rounded-md bg-white border border-gray-200 text-gray-800 text-[10px] font-bold"
                            >
                              {tag}
                            </span>
                          ))}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full text-xs font-medium bg-gray-50 border border-gray-200 rounded-xl p-2.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-brand-500"
                    />
                  </div>
                  ...
                  {reviewResult && (
                    <div className="bg-purple-50/60 border border-purple-200 rounded-2xl p-4 space-y-2 shadow-xs">
                      <div className="flex items-center justify-between">
                      ...
                      <p className="text-xs text-gray-800 leading-relaxed bg-white p-3 rounded-xl border border-purple-100">
                        "{reviewResult.reply}"
                      </p>
                    </div>
                  )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="p-3.5 bg-rose-50 border border-rose-200/80 rounded-xl">
                          ...
                          <span className="text-sm font-black text-rose-800 flex items-center gap-1 mt-0.5">
